...
export const START_GET_LIST_CATEGORIES = "START_GET_LIST_CATEGORIES";
export const COMPLETE_GET_LIST_CATEGORIES = "COMPLETE_GET_LIST_CATEGORIES";
export const ERROR_GET_LIST_CATEGORIES = "ERROR_GET_LIST_CATEGORIES";
